...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  setup do
    @apartment = apartments(:marlborough_apt)
  end
  ...
  test "should occupy apartment" do
    patch occupy_apartment_url(@apartment), params: { apartment: { id: @apartment.id } }
    assert_redirected_to apartment_url(@apartment)
  end

  test "should vacate apartment" do
    patch vacate_apartment_url(@apartment), params: { apartment: { id: @apartment.id } }
    assert_redirected_to apartment_url(@apartment)
  end
